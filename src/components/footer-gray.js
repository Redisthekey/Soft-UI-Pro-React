      ...
      <div className="footer-gray-container">
        <div className="footer-gray-container1">
          <div className="footer-gray-container2">
            <span className="footer-gray-text">RIOT GAMES</span>
            ...
            <div className="footer-gray-container3">
              ...
              <svg viewBox="0 0 1024 1024" className="footer-gray-icon06">
              ...
              <svg viewBox="0 0 1024 1024" className="footer-gray-icon08">
          ...
          <div className="footer-gray-container4">
            <div className="footer-gray-container5">
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="footer-gray-link1 large"
              >
                Facebook
              </a>
            </div>
            <div className="footer-gray-container6">
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="footer-gray-link2 large"
              >
                Twitter
              </a>
            </div>
            <div className="footer-gray-container7">
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="footer-gray-link3 large"
              >
                Youtube
              </a>
            </div>
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="footer-gray-link4"
            >
              <div className="footer-gray-container8">
                <span className="footer-gray-text2 large">Instagram</span>
              </div>
            </a>
          </div>
        </div>
        <span className="footer-gray-text3 small">
          <span>
            © 2022 RiOT GAMES, INC. RIOT GAMES, VALORANT, AND ANY ASSOCIATED
            LOGOS ARE TRADEMARKS, SERVICE
          </span>
          <br></br>
          <span>MARKS, AND/OR REGISTERED TRADEMARKS OF RIOT GAMES, INC.</span>
        </span>
      </div>
    </footer>
  )
